"""Native cognis-connect emit for airlock — forward findings to any platform.

Maps airlock's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    airlock ... --format json | airlock-emit --to stix
    airlock-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
